%% here tend = 6h
%% we also return CNAmodel for creating xgmml file for cytoscape
% clear all;
% clc;
function [specID,y0,tCum yCum,CNAmodel] = Netflux_NJ_for_predefined_inp_and_y0_ymax_V3(indices_in_orig_w, ...
            values_for_w_in_netFlux, fname, pathname,It2reachSS,flgY0,y0_,flgYmx,yMax_ind,yMax_val)
