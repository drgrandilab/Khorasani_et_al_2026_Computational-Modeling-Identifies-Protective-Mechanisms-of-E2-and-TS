...
fileName_CTL = [fileName_prefix,'72h_T1.txt'];
...
% Define new colors
grayColors = [0 0 0; 0.4 0.4 0.4; 0.7 0.7 0.7; 1 1 1];

% Apply colors to each group
for i = 1:numel(h)
    h(i).FaceColor = grayColors(i,:);
end
